<?php
// PHP file to serve as a reusable header for the PoolPracticeTracker website.
// Includes the HTML structure, viewport settings, Tailwind CSS (for base utility/responsive scaffolding),
// and the main navigation bar, now using semantic CSS classes defined in style.css.
...
<head>
    ...
    <title>PoolPracticeTracker.com | <?php echo $page_title; ?></title>
...
<header class="main-header">
    ...
    <div class="md:hidden bg-secondary border-t border-gray-700 hidden" id="mobile-menu">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a href="login.php" class="text-white hover:bg-gray-700 block px-3 py-2 rounded-md text-base font-medium">Login</a>
...
<?php
// This header is designed to be included at the beginning of every page file.
?>
